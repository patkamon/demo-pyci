"""Calculate standard and variance."""
...
def variance(data):
    """
    Calculate The population variance of a list (array) of numbers in data.
...
def stdev(data):
    """Calculate standard deviation of a list of data values."""
